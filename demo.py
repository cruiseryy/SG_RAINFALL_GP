...
if __name__ == '__main__':
    ...
    ax[0][0].boxplot(cc0[:,:,0], positions= ps - 0.5, widths = 0.4, patch_artist=True, boxprops={'facecolor': 'skyblue'}, flierprops={'markersize': 3})
    ax[0][0].boxplot(cc1[:,:,0], positions= ps, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='lightgreen'), flierprops={'markersize': 3})
    ax[0][0].boxplot(cc1[:,:,1], positions= ps + 0.5, widths = 0.4, flierprops={'markersize': 3})
    ...
    ax[0][1].boxplot(kge0[:,:,0], positions= ps - 0.5, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='skyblue'), flierprops={'markersize': 3})
    ax[0][1].boxplot(kge1[:,:,0], positions= ps, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='lightgreen'), flierprops={'markersize': 3})
    ax[0][1].boxplot(kge1[:,:,1], positions= ps + 0.5, widths = 0.4, flierprops={'markersize': 3})
    ...
    ax[1][0].boxplot(cc0[:,:,0].T, positions= ps - 0.5, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='skyblue'), flierprops={'markersize': 3})
    ax[1][0].boxplot(cc1[:,:,0].T, positions= ps, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='lightgreen'), flierprops={'markersize': 3})
    ax[1][0].boxplot(cc1[:,:,1].T, positions= ps + 0.5, widths = 0.4, flierprops={'markersize': 3})
    ...
    ax[1][1].boxplot(kge0[:,:,0].T, positions= ps - 0.5, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='skyblue'), flierprops={'markersize': 3})
    ax[1][1].boxplot(kge1[:,:,0].T, positions= ps, widths = 0.4, patch_artist=True, boxprops=dict(facecolor='lightgreen'), flierprops={'markersize': 3})
    ax[1][1].boxplot(kge1[:,:,1].T, positions= ps + 0.5, widths = 0.4, flierprops={'markersize': 3})
